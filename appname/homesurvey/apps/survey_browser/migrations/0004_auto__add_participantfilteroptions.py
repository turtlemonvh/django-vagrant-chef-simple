...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ParticipantFilterOptions'
        db.create_table('survey_browser_participantfilteroptions', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filter_field', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('option_dict', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('survey_browser', ['ParticipantFilterOptions'])


    def backwards(self, orm):
        # Deleting model 'ParticipantFilterOptions'
        db.delete_table('survey_browser_participantfilteroptions')
    ...
    models = {
        ...
        'survey_browser.participantfilteroptions': {
            'Meta': {'object_name': 'ParticipantFilterOptions'},
            'filter_field': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'option_dict': ('django.db.models.fields.TextField', [], {})
        },
        ...
        'survey_browser.participantmetafilter': {
            ...
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metafilters': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'associated_metafilters'", 'symmetrical': 'False', 'to': "orm['survey_browser.ParticipantMetaFilter']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
