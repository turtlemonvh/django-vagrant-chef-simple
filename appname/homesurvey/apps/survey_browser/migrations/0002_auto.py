...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('survey_browser_participantmetafilter_metafilters', ['participantmetafilter_id', 'participantfilter_id'])
    ...
    models = {
        ...
        'survey_browser.participantmetafilter': {
            ...
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metafilters': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'metafilters'", 'symmetrical': 'False', 'to': "orm['survey_browser.ParticipantFilter']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
